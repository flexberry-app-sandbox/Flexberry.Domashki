...
moduleForAcceptance('[AGAT] Acceptance | i i s domashki дисциплина l');

test('testing i-i-s-domashki-дисциплина-l', function(assert) {
  visit('/i-i-s-domashki-дисциплина-l');
